...
<button className="swiper-button-next flex items-center justify-center w-5 h-5 text-white  shadow-md rounded-full bg-black ">
    ...
    {showPopup && <Booking  onClose={() => setShowPopup(false)} Batch={data.batch} reserveamount={data.reserveamount} foramount={data.amount} withoutamount={data.fromamount} Name={data.name} /> }
